...
<body>
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-between">
      <div class="contact-info d-flex align-items-center">
        ...
        <i class="bi bi-person-circle"></i> <a href="login.php">Admin</a>
      </div>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">MediPOD</a></h1>
  ...
  <main id="main">
    ...
    <section id="calendar_sec" class="calendar_sec">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="calendar">
            <iframe src="https://calendar.google.com/calendar/embed?height=600&wkst=1&bgcolor=%236bbae4&ctz=America%2FSantiago&title=Citas%20Podologicas&showTz=0&showTabs=1&showPrint=0&showNav=1&src=M2tnbWM1ZXFvdTM0NW1ka3VrZmR1aGFubWFnajczdmZAaW1wb3J0LmNhbGVuZGFyLmdvb2dsZS5jb20&color=%23795548" style="border:solid 1px #777" width="70%" height="600" frameborder="0" scrolling="no" ></iframe>
          </div>
        </div>
      </div>
    ...
    <section id="about" class="about">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          </div>--><!--   **esto es para poner un video**

          <div id="buscador" class="buscador col-xl-9 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
